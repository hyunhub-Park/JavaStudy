...
//			boolean idCheck = studentDao.studentIdCheck(id); // 아이디 체크
//			if (idCheck == false)
//			{
//				break;
//			}
...
//
//		// 학과번호 출력.
//		subjectList = subjectDao.subjectSelect();	// 데이터를 받았으니, 화면에 출력해야 함. jsp로 만들 것.	
//		if (subjectList == null)
//		{
//			System.out.println("데이터가 존재하지 않습니다.");
//			return;
...
//		SimpleDateFormat sdf = new SimpleDateFormat("yy");
//		String year = sdf.format(new Date());
//		String num = year + s_num + studentDao.getStudentCount(s_num);	// 전체 count가 얼마인지.
////		String num = year + s_num + "0001";
//
//		System.out.print("생년월일(8자리 : 19990909) : ");
//		String birthday = sc.nextLine();
...
//		}
//		
//		// 검색이 아닌 전체 학생정보를 출력할 수 있도록.
//		System.out.println();
//		System.out.println("등록 학생 정보");
//		studentDao.getStudentSelect(num); // pk.
//		// sd.getStudent(svo.getSd_id(), svo.getSd_passwd());
//		System.out.println();
//		
//		
